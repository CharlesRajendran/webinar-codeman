...
export function activate(context: vscode.ExtensionContext) {
	...
	context.subscriptions.push(
		vscode.commands.registerCommand('webinar-codeman.chat', () => {
			panel.webview.postMessage({ message: 'Hi broooooo.....' });
		})
	);

	context.subscriptions.push(vscode.commands.registerCommand('webinar-codeman.start', () => {
